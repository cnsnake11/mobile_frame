...
public class SlideDateTimePicker
{
    ...
    public static class Builder
    {
        ...
        /**
         * @see SlideDateTimePicker#setInitialDate(java.util.Date)
         */
        ...
        /**
         * @see SlideDateTimePicker#setMinDate(java.util.Date)
         */
        ...
        /**
         * @see SlideDateTimePicker#setMaxDate(java.util.Date)
         */
